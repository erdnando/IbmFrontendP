...
export class ARPComponent {
  ...
  cargaGMT() {
    this.MListGMT.push({id:1, time:'(GMT-01:00) Azores',diferencia:-1});
    this.MListGMT.push({id:2, time:'(GMT-01:00) Cape Verde Island',diferencia:-1});
    this.MListGMT.push({id:3, time:'(GMT-02:00)  Mid-Atlantic',diferencia:-2});
    this.MListGMT.push({id:4, time:'(GMT-03:00) Brasilia',diferencia:-3});
    this.MListGMT.push({id:5, time:'(GMT-03:00) Buenos Aires, Georgetown',diferencia:-3});
    this.MListGMT.push({id:6, time:'(GMT-03:00) Greenland',diferencia:-3});
    this.MListGMT.push({id:7, time:'(GMT-03:30) Newfoundland and Labrador',diferencia:-3.5});
    this.MListGMT.push({id:8, time:'(GMT-04:00) Atlantic Time (Canada)',diferencia:-4});
    this.MListGMT.push({id:9, time:'(GMT-04:00) Caracas, La Paz',diferencia:-4});
    this.MListGMT.push({id:10, time:'(GMT-04:00) Manaus',diferencia:-4});
    this.MListGMT.push({id:11, time:'(GMT-04:00) Santiago',diferencia:-4});
    this.MListGMT.push({id:12, time:'(GMT-05:00)  Bogota, Lima, Quito',diferencia:-5});
    ...
    this.MListGMT.push({id:17, time:'(GMT-06:00) Guadalajara, Mexico City, Monterrey ',diferencia:-6});
    ...
    this.MListGMT.push({id:20, time:'(GMT-07:00) Chihuahua, La Paz, Mazatlan ',diferencia:-7});
    this.MListGMT.push({id:21, time:'(GMT-07:00)  Mountain Time (US and Canada)',diferencia:-7});
    this.MListGMT.push({id:22, time:'(GMT-08:00)  Pacific Time (US and Canada); Tijuana ',diferencia:-8});
